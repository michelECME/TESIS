...
class ChoferResourceIT {
    ...
    public static Chofer createEntity(EntityManager em) {
        Chofer chofer = new Chofer().nombre(DEFAULT_NOMBRE).licencia(DEFAULT_LICENCIA);
        return chofer;
    }
    ...
    public static Chofer createUpdatedEntity(EntityManager em) {
        Chofer chofer = new Chofer().nombre(UPDATED_NOMBRE).licencia(UPDATED_LICENCIA);
        return chofer;
    }
    ...
    void putNewChofer() throws Exception {
        ...
        updatedChofer.nombre(UPDATED_NOMBRE).licencia(UPDATED_LICENCIA);
    ...
    void fullUpdateChoferWithPatch() throws Exception {
        ...
        partialUpdatedChofer.nombre(UPDATED_NOMBRE).licencia(UPDATED_LICENCIA);
